<template>
  <div class="header_nav">
    ...
    <section class="menu">
      <div class="container">
        <ul class="nav_content">
          ...
          <li>
            <div class="nav_item item1"
            @click="toggleMenu(2)">
              <img
                src="../assets/icon/menu/tablet.png"
                alt="iconWatch"
    ...
    <div id="menu__dropdown" class="container" v-if="isShowMenu">
      <div class="menu_dropdown">
        <div class="nav_left">
          <div class="nav_left_item" @click="toggleMenu(1)" :class="{'nav_left_item_active': activeMenu === 1}">
            <p>ĐIỆN THOẠI</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(2)" :class="{'nav_left_item_active': activeMenu === 2}">
            <p>MÁY TÍNH BẢNG</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(3)" :class="{'nav_left_item_active': activeMenu === 3}">
            <p>WATCH</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(4)" :class="{'nav_left_item_active': activeMenu === 4}">
            <p>MÁY TÍNH APPLE</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(5)" :class="{'nav_left_item_active': activeMenu === 5}">
            <p>LOA DI ĐỘNG</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(6)" :class="{'nav_left_item_active': activeMenu === 6}">
            <p>TAI NGHE</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(7)" :class="{'nav_left_item_active': activeMenu === 7}">
            <p>SẢN PHẨM APPLE</p>
          </div>
          <div class="nav_left_item" @click="toggleMenu(8)" :class="{'nav_left_item_active': activeMenu === 8}">
            <p>BALO</p>
          </div>
        </div>
